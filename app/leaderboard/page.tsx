...
// Tambahkan baris ini agar Next.js TIDAK men-cache halaman ini di production
export const dynamic = "force-dynamic";

export default async function LeaderboardPage() {
  const user = await getUser();

  // Filter ADMIN langsung dari level database, bukan dari UI
    ...
    <main className="relative min-h-screen bg-zinc-950 text-zinc-100 selection:bg-emerald-500/30 pb-20">
      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 py-12 lg:py-20">
        ...
        <div className="overflow-hidden rounded-2xl border border-zinc-800/60 bg-zinc-900/50 backdrop-blur-xl shadow-2xl">
          <div className="overflow-x-auto">
            <table className="w-full whitespace-nowrap text-left">
              ...
              <tbody className="divide-y divide-zinc-800/50">
                {/* Kita langsung melakukan .map karena data 'users' sudah bersih dari ADMIN */}
          ...
          {/* Empty State sekarang akan mengecek array users yang benar-benar kosong dari pemain */}
          {users.length === 0 && (
